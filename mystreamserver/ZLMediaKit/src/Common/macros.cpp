 ...
 */
#if !defined(ENABLE_VERSION)
const char kServerName[] =  "DigitalBloom Stream Server(build in " __DATE__ " " __TIME__ ")";
#else
const char kServerName[] =  "DigitalBloom Stream Server(build in " __DATE__ " " __TIME__ ")";
//const char kServerName[] = "DigitalBloom Stream Server(git hash:" COMMIT_HASH "/" COMMIT_TIME ",branch:" BRANCH_NAME ",build time:" BUILD_TIME ")";
#endif
