...
public:
    LogChannel(const std::string &name, LogLevel level = LError);
    virtual ~LogChannel();
...
public:
    ...
    EventChannel(const std::string &name = "EventChannel", LogLevel level = LError);
...
public:
    ConsoleChannel(const std::string &name = "ConsoleChannel", LogLevel level = LError);
...
public:
    FileChannelBase(const std::string &name = "FileChannelBase", const std::string &path = exePath() + ".log", LogLevel level = LError);
...
public:
    FileChannel(const std::string &name = "FileChannel", const std::string &dir = exeDir() + "log/", LogLevel level = LError);
...
public:
    SysLogChannel(const std::string &name = "SysLogChannel", LogLevel level = LError);
