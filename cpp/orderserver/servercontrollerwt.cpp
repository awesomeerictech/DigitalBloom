...
void MapperSoftware::mytimerendpointuser() {
    ...
    timercarousel->stop();
     ...
     showCustomWidgetT("spinner1","myspinner1",allitems_); // modified this
   //  isstartup = true;
...
allitems_->bindWidget("mediasrcaac", std::move(appviewordinaryimage1aac_));
 ...
 //  allitems_->bindWidget("favourite",std::move(carousel));
  ...
  if(allitems_->find("itemlink1aaa"))
      allitems_->find("itemlink1aaa")->show();
  if(allitems_->find("mediasrcaaa"))
      allitems_->find("mediasrcaaa")->show();
  if(allitems_->find("fav1"))
      allitems_->find("fav1")->show();
  if(allitems_->find("name1"))
      allitems_->find("name1")->show();
  if(allitems_->find("des1"))
      allitems_->find("des1")->show();
  if(allitems_->find("itemlink2aab"))
      allitems_->find("itemlink2aab")->show();
  if(allitems_->find("mediasrcaab"))
      allitems_->find("mediasrcaab")->show();
  if(allitems_->find("fav2"))
      allitems_->find("fav2")->show();
  if(allitems_->find("name2"))
      allitems_->find("name2")->show();
  if(allitems_->find("des2"))
      allitems_->find("des2")->show();
  if(allitems_->find("itemlink3aac"))
      allitems_->find("itemlink3aac")->show();
  if(allitems_->find("mediasrcaac"))
      allitems_->find("mediasrcaac")->show();
  if(allitems_->find("fav3"))
      allitems_->find("fav3")->show();
  if(allitems_->find("name3"))
      allitems_->find("name3")->show();
  if(allitems_->find("des3"))
      allitems_->find("des3")->show();
...
// allitems_->bindEmpty("name3");
  ...
  allitems_->setTemplateText(str1);
  if(allitems_->find("itemlink1aaa"))
      allitems_->find("itemlink1aaa")->hide();
  if(allitems_->find("mediasrcaaa"))
      allitems_->find("mediasrcaaa")->hide();
  if(allitems_->find("fav1"))
      allitems_->find("fav1")->hide();
  if(allitems_->find("name1"))
      allitems_->find("name1")->hide();
  if(allitems_->find("des1"))
      allitems_->find("des1")->hide();
  if(allitems_->find("itemlink2aab"))
      allitems_->find("itemlink2aab")->hide();
  if(allitems_->find("mediasrcaab"))
      allitems_->find("mediasrcaab")->hide();
  if(allitems_->find("fav2"))
      allitems_->find("fav2")->hide();
  if(allitems_->find("name2"))
      allitems_->find("name2")->hide();
  if(allitems_->find("des2"))
      allitems_->find("des2")->hide();
  if(allitems_->find("itemlink3aac"))
      allitems_->find("itemlink3aac")->hide();
  if(allitems_->find("mediasrcaac"))
      allitems_->find("mediasrcaac")->hide();
  if(allitems_->find("fav3"))
      allitems_->find("fav3")->hide();
  if(allitems_->find("name3"))
      allitems_->find("name3")->hide();
  if(allitems_->find("des3"))
      allitems_->find("des3")->hide();
  showToast(Wt::WString::tr("appview-view25"));
    ...
    showCustomWidgetT("spinner1","myspinner1",allitems_);
     ...
     //   Wt::WModelIndex  myindex = itemsfilter->index(0,5);
         ...
         for (int card = 0; card < allrows; ++card) {
          ...
          Wt::cpp17::any mydataitemid = itemsfilter->data(card,3);
          Wt::WString dataitemid = Wt::cpp17::any_cast<Wt::WString>(mydataitemid);
    ...
    /*      auto containerplayer = std::make_unique<Wt::WContainerWidget>();
        ...
        //  appviewembedyoutube1->hide();
         ...
         appview8_->bindWidget("mediasrc", std::move(containervideo));
          ...
          auto itemuuid_ = std::make_unique<Wt::WTemplate>();
          auto uuiditem = Wt::WString::tr("appview-view26");
          itemuuid_->setTemplateText(uuiditem);
          itemuuid_->bindString("myitemid",dataitemid,Wt::TextFormat::Plain);
          ...
          appview8_ ->bindWidget("itemid", std::move(itemuuid_));
