...
public:
     ...
     *    };
     *
     *    QSqlDatabase db = man.openDatabase("/root/qtprojects/QVARIANTMORE/test.sqlite");
     ...
     * @code
     *    SqliteManager man;
     *    sqlite3 *db = man.openDatabase("/root/qtprojects/QVARIANTMORE/test.sqlite");
     ...
     *    };
     *
     *    QFile file("/root/qtprojects/QVARIANTMORE/Pictures/Wallpapers/batman_trilogy_2-wallpaper-1440x1080.jpg");
     ...
     * insertIntoTable(db, const QString &tableName, const QMap<QString, QVariant> &row);
     * @endcode
     * @param database
     * @param tableName
