...
#define SETTINGS_DB_FILE_NAME "eric_settings.sqlite"
 ...
 */
class SettingsManagerEric : public QObject
{
    Q_OBJECT
...
public:
    explicit SettingsManagerEric(QString databaseName = SETTINGS_DB_FILE_NAME, QString tableName = "settings", QObject *parent = 0);
    ~SettingsManagerEric();
    ...
    void startsetting() {
        ...
        qDebug()<<"Setting started successfully";
...
private:
    ...
    static QList<SettingsManagerEric *> m_Instances;
