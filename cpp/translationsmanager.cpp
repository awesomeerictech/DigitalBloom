...
TranslationsManager::TranslationsManager(QObject *parent)
  ...
  m_enTranslator.load(QLocale{QLocale::English}, QLatin1String("DigitalBloom"),
                      QLatin1String("_"), QLatin1String(":/translations/"));

  m_frTranslator.load(QLocale{QLocale::French}, QLatin1String("DigitalBloom"),
                      QLatin1String("_"), QLatin1String(":/translations/"));

  m_esTranslator.load(QLocale{QLocale::Spanish}, QLatin1String("DigitalBloom"),
                      QLatin1String("_"), QLatin1String(":/translations/"));

  m_deTranslator.load(QLocale{QLocale::German}, QLatin1String("DigitalBloom"),
                      QLatin1String("_"), QLatin1String(":/translations/"));

  m_itTranslator.load(QLocale{QLocale::Italian}, QLatin1String("DigitalBloom"),
                      QLatin1String("_"), QLatin1String(":/translations/"));

  m_jaTranslator.load(QLocale{QLocale::Japanese}, QLatin1String("DigitalBloom"),
                      QLatin1String("_"), QLatin1String(":/translations/"));
