...
Item {
    ...
    // colors
    property string colorContent: EricTheme.colorComponentText
    property string colorContentHighlight: EricTheme.colorComponentContent
    property string colorBackgroundHighlight: EricTheme.colorComponentDown
