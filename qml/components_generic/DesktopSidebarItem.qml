...
Item {
    ...
    // colors
    property string colorContent: EricTheme.colorSidebarContent
    property string colorHighlight: EricTheme.colorSidebarHighlight
        ...
        IconSvg {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    opacity: 0.66
                    color: EricTheme.colorHighContrast
                }
                ...
                IconSvg {
                    ...
                    color: EricTheme.colorLowContrast
