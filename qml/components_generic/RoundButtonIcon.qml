...
Item {
    ...
    // colors
    property string iconColor: EricTheme.colorIcon
    property string highlightColor: EricTheme.colorPrimary
    property string borderColor: EricTheme.colorComponentBorder
    property string backgroundColor: EricTheme.colorComponent
    ...
    Rectangle { // background
        ...
        border.width: {
            if (control.border || ((control.hovered || control.selected) && control.highlightMode === "border"))
                return EricTheme.componentBorderWidth
            return 0
        }
