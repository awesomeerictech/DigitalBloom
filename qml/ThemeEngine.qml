...
Item {
    ...
    function getThemeIndex(name) {
        ...
        if (name === "THEME_LIGHT_DESKTOP") return EricTheme.THEME_LIGHT_DESKTOP
        if (name === "THEME_DARK_DESKTOP") return EricTheme.THEME_DARK_DESKTOP
        if (name === "THEME_LIGHT_MOBILE") return EricTheme.THEME_LIGHT_MOBILE
        if (name === "THEME_DARK_MOBILE") return EricTheme.THEME_DARK_MOBILE
    ...
    function getThemeName(index) {
        ...
        if (index === EricTheme.THEME_LIGHT_DESKTOP) return "THEME_LIGHT_DESKTOP"
        if (index === EricTheme.THEME_DARK_DESKTOP) return "THEME_DARK_DESKTOP"
        if (index === EricTheme.THEME_LIGHT_MOBILE) return "THEME_LIGHT_MOBILE"
        if (index === EricTheme.THEME_DARK_MOBILE) return "THEME_DARK_MOBILE"
    ...
    function loadTheme(newIndex) {
        ...
        if (themeIndex < 0 || themeIndex >= EricTheme.THEME_LAST) {
            themeIndex = EricTheme.THEME_PLANT // default theme
        }
        ...
        if (themeIndex === EricTheme.THEME_LIGHT_DESKTOP) {
        ...
        } else if (themeIndex === EricTheme.THEME_DARK_DESKTOP) {
        ...
        } else if (themeIndex === EricTheme.THEME_LIGHT_MOBILE) {
        ...
        } else if (themeIndex === EricTheme.THEME_DARK_MOBILE) {
