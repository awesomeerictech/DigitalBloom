    ...
    sourceComponent: Rectangle {
        ...
        Item {
            ...
            Item { // debug infos (top/left)
                anchors.top: parent.top
                anchors.topMargin: EricTheme.componentMargin + Math.max(screenPaddingTop, screenPaddingStatusbar)
                anchors.left: parent.left
            ...
            Row { // menus (top/right)
                id: toprightmenus
                anchors.top: parent.top
                anchors.topMargin: EricTheme.componentMargin + Math.max(screenPaddingStatusbar, screenPaddingTop)
                anchors.right: parent.right
                anchors.rightMargin: EricTheme.componentMargin
                height: 48

                spacing: EricTheme.componentMarginL
                ...
                Item { // drag and drop
                    ...
                    IconSvg {
                        ...
                        anchors.centerIn: parent
                        color: fileOpenDialog.visible ? EricTheme.colorYellow : "white"
                ...
                Item { // debug settings
                    ...
                    IconSvg {
                        ...
                        height: parent.height * 0.6
                        anchors.centerIn: parent
                        color: menuDebug.visible ? EricTheme.colorYellow : "white"
                ...
                Item { // debug format selector
                   ...
                   // visible: (currentMode === "video")
                    ...
                    IconSvg {
                        ...
                        height: parent.height * 0.6
                        anchors.centerIn: parent
                        color: menuFormats.visible ? EricTheme.colorYellow : "white"
                ...
                Item { // camera selector
                    ...
                    IconSvg {
                        ...
                        anchors.centerIn: parent
                        color: menuCamera.visible ? EricTheme.colorYellow : "white"
...
*/
            ...
            Column { // bottom menus
                ...
                anchors.bottom: parent.bottom
                anchors.bottomMargin: EricTheme.componentMarginL + Math.max(screenPaddingBottom, screenPaddingNavbar)
                ...
                RowLayout { // buttons bar
                    ...
                    Item {
                        ...
                        IconSvg {
                            ...
                            anchors.centerIn: parent
                            color: (camera.torchMode === Camera.TorchOn) ? EricTheme.colorYellow : "white"
                            source: {
                    ...
                    Item {
                        ...
                        IconSvg {
                            ...
                            height: parent.height * 0.666
                            anchors.centerIn: parent
                            color: (appDrawer.opened || menuScreens.visible) ? EricTheme.colorYellow : "white"
