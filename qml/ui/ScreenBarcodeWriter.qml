...
Loader {
    ...
    sourceComponent: Flickable {
        ...
        contentWidth: -1
        contentHeight: gridContent.height + 100
        ...
        Grid {
            ...
            columnSpacing: EricTheme.componentMarginXL * (singleColumn ? 1 : 2)
            rows: 2
            rowSpacing: EricTheme.componentMarginXL * (singleColumn ? 1 : 2)
            ...
            Item { // pane 1
                ...
                Item {
                    ...
                    onTriggered: {
                        ...
                        console.log("url is: "+ ("http://"+streamserver.getLocalIp()+":8180/?_=/my-items/all-items&business="))
                        barcodeImage.urltxt = ("http://"+streamserver.getLocalIp()+":8180/?_=/my-items/all-items&business=")
                    ...
                    Image {
                        ...
                        source: {
                            ...
                            if (settingsManager.backend_writer === "zxingcpp") return "image://ZXingQt/encode/" + barcodeImage.urltxt + barcodeAdvanced.barcode_string + barcodeAdvanced.barcode_settings_zxingcpp
                    ...
                    Rectangle {
                        ...
                        border.width: 2
                        border.color: EricTheme.colorError
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            if (isMobile && barcodeAdvanced.barcode_string) {
                                popupBarcodeFullscreen.full_url = (barcodeImage.urltxt + barcodeAdvanced.barcode_string)
                                popupBarcodeFullscreen.open()
                            }
                            else {

                                Qt.openUrlExternally(barcodeImage.urltxt + barcodeAdvanced.barcode_string)
                            }
                        }
                ...
                Column {
                    ...
                    TextFieldThemed {
                       ...
                       // visible: (selectorBarcodes.currentMode == "1d") // linear
                        placeholderText: qsTr("Type your username here!")
                    ...
                    TextAreaThemed {
                        ...
                        height: isPhone ? 96 : 128 // 96 mobile

                      //  visible: (selectorBarcodes.currentMode === "2d") // matrix
                        placeholderText: qsTr("Type the username for your business here")

                        wrapMode: Text.WrapAnywhere
                        selectByMouse: true
                        onTextChanged: barcodeAdvanced.barcode_string = text
                        // just disabled this for ui
                        // SelectorMenu {
