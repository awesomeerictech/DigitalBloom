...
Rectangle {
    ...
    Rectangle { // OS statusbar area
        ...
        color: EricTheme.colorStatusbar
    }
        ...
        Row { // left area
            ...
            MouseArea { // left button
                ...
                RippleThemed {
                    ...
                    color: Qt.rgba(EricTheme.colorHeaderHighlight.r, EricTheme.colorHeaderHighlight.g, EricTheme.colorHeaderHighlight.b, 0.33)
                }
            ...
            Text { // header title
                ...
                text: headerTitle
                font.bold: true
                font.pixelSize: EricTheme.fontSizeHeader
                color: EricTheme.colorHeaderContent
    ...
    Rectangle { // bottom separator
        ...
        color: EricTheme.colorHeaderHighlight
