                ...
                Column {
                    ...
                    Item {
                        ...
                        Image {
                            id: barcodeImage
                            anchors.fill: parent
                            anchors.margins: EricTheme.componentMargin
            ...
            Item { // pane 2
                ...
                Column {
                    ...
                    Rectangle { // barcode content // multiple lines
                        anchors.left: parent.left
                        anchors.right: parent.right
                        height: barcodecontent.contentHeight + EricTheme.componentMargin*2
                        radius: EricTheme.componentRadius
                        ...
                        RowLayout {
                            ...
                            IconSvg {
                                ...
                                color: mm.containsMouse ? EricTheme.colorPrimary : EricTheme.colorIcon
                                source: {
