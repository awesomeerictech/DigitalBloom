...
Flickable {
    ...
    Column {
        ...
        anchors.leftMargin: isDesktop ? EricTheme.componentMarginL : EricTheme.componentMargin
        anchors.right: parent.right
        anchors.rightMargin: isDesktop ? EricTheme.componentMarginL : EricTheme.componentMargin
        ...
        ListView {
            ...
            topMargin: EricTheme.componentMarginL
            bottomMargin: EricTheme.componentMarginL

            height: count * 32 + 3*48 + EricTheme.componentMarginL
            interactive: false
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    Layout.margins: 2
                    radius: 4
                    color: Qt.darker(EricTheme.colorForeground, 1.02)
    ...
    component GridDelegate: RowLayout {
        ...
        Rectangle {
            ...
            color: {
                if (parent.decode === ScreenAboutFormats.SupportLevel.Supported) return EricTheme.colorGreen
                if (parent.decode === ScreenAboutFormats.SupportLevel.Incomplete) return EricTheme.colorOrange
        ...
        Rectangle {
            ...
            color: {
                if (parent.encode === ScreenAboutFormats.SupportLevel.Supported) return EricTheme.colorGreen
                if (parent.encode === ScreenAboutFormats.SupportLevel.Incomplete) return EricTheme.colorOrange
                return EricTheme.colorBackground
            }
        }
    }
