...
Item {
    ...
    function getThemeIndex(name) {
        if (name === "THEME_MOBILE_LIGHT") return EricTheme.THEME_MOBILE_LIGHT
        if (name === "THEME_MOBILE_DARK") return EricTheme.THEME_MOBILE_DARK

        if (name === "THEME_MATERIAL_LIGHT") return EricTheme.THEME_MATERIAL_LIGHT
        if (name === "THEME_MATERIAL_DARK") return EricTheme.THEME_MATERIAL_DARK

        if (name === "THEME_DESKTOP_LIGHT") return EricTheme.THEME_DESKTOP_LIGHT
        if (name === "THEME_DESKTOP_DARK") return EricTheme.THEME_DESKTOP_DARK

        if (name === "THEME_SNOW") return EricTheme.THEME_SNOW
        if (name === "THEME_PLANT") return EricTheme.THEME_PLANT
        if (name === "THEME_RAIN") return EricTheme.THEME_RAIN
        if (name === "THEME_DAY") return EricTheme.THEME_DAY
        if (name === "THEME_NIGHT") return EricTheme.THEME_NIGHT

        if (name === "THEME_LIGHT_AND_WARM") return EricTheme.THEME_LIGHT_AND_WARM
        if (name === "THEME_DARK_AND_SPOOKY") return EricTheme.THEME_DARK_AND_SPOOKY
        if (name === "THEME_PLAIN_AND_BORING") return EricTheme.THEME_PLAIN_AND_BORING
        if (name === "THEME_BLOOD_AND_TEARS") return EricTheme.THEME_BLOOD_AND_TEARS
        if (name === "THEME_MIGHTY_KITTENS") return EricTheme.THEME_MIGHTY_KITTENS

        return -1
    }

    function getThemeName(index) {
        if (index === EricTheme.THEME_MOBILE_LIGHT) return "THEME_MOBILE_LIGHT"
        if (index === EricTheme.THEME_MOBILE_DARK) return "THEME_MOBILE_DARK"

        if (index === EricTheme.THEME_MATERIAL_LIGHT) return "THEME_MATERIAL_LIGHT"
        if (index === EricTheme.THEME_MATERIAL_DARK) return "THEME_MATERIAL_DARK"

        if (index === EricTheme.THEME_DESKTOP_LIGHT) return "THEME_DESKTOP_LIGHT"
        if (index === EricTheme.THEME_DESKTOP_DARK) return "THEME_DESKTOP_DARK"

        if (index === EricTheme.THEME_SNOW) return "THEME_SNOW"
        if (index === EricTheme.THEME_PLANT) return "THEME_PLANT"
        if (index === EricTheme.THEME_RAIN) return "THEME_RAIN"
        if (index === EricTheme.THEME_DAY) return "THEME_DAY"
        if (index === EricTheme.THEME_NIGHT) return "THEME_NIGHT"

        if (index === EricTheme.THEME_LIGHT_AND_WARM) return "THEME_LIGHT_AND_WARM"
        if (index === EricTheme.THEME_DARK_AND_SPOOKY) return "THEME_DARK_AND_SPOOKY"
        if (index === EricTheme.THEME_PLAIN_AND_BORING) return "THEME_PLAIN_AND_BORING"
        if (index === EricTheme.THEME_BLOOD_AND_TEARS) return "THEME_BLOOD_AND_TEARS"
        if (index === EricTheme.THEME_MIGHTY_KITTENS) return "THEME_MIGHTY_KITTENS"
    ...
    function loadTheme(newIndex) {
        //console.log("EricTheme.loadTheme(" + newIndex + ")")
        var themeIndex = -1
        ...
        if (themeIndex < 0 || themeIndex >= EricTheme.THEME_LAST) {
            if (isDesktop) themeIndex = EricTheme.THEME_DESKTOP_LIGHT
            else if (isMobile) themeIndex = EricTheme.THEME_MOBILE_LIGHT
        }
        ...
        if (settingsManager.appThemeAuto) {
            ...
            if (hour >= 21 || hour <= 8) {
                if (themeIndex === EricTheme.THEME_MOBILE_LIGHT)
                    themeIndex = EricTheme.THEME_MOBILE_DARK

                if (themeIndex === EricTheme.THEME_MATERIAL_LIGHT)
                    themeIndex = EricTheme.THEME_MATERIAL_DARK

                if (themeIndex === EricTheme.THEME_DESKTOP_LIGHT)
                    themeIndex = EricTheme.THEME_DESKTOP_DARK

                if (themeIndex === EricTheme.THEME_SNOW ||
                    themeIndex === EricTheme.THEME_PLANT ||
                    themeIndex === EricTheme.THEME_RAIN ||
                    themeIndex === EricTheme.THEME_DAY)
                    themeIndex = EricTheme.THEME_NIGHT

                if (themeIndex === EricTheme.THEME_LIGHT_AND_WARM ||
                    themeIndex === EricTheme.THEME_PLAIN_AND_BORING)
                    themeIndex = EricTheme.THEME_DARK_AND_SPOOKY

                // theme doesn't have a dark variant set? just don't change the EricTheme...
            }
        }
        ...
        } else if (themeIndex === EricTheme.THEME_MOBILE_DARK) {
        ...
        } else if (themeIndex === EricTheme.THEME_MATERIAL_LIGHT) { /////////
        ...
        } else if (themeIndex === EricTheme.THEME_MATERIAL_DARK) {
        ...
        } else if (themeIndex === EricTheme.THEME_DESKTOP_LIGHT) { ///////////
        ...
        } else if (themeIndex === EricTheme.THEME_DESKTOP_DARK) {
        ...
        } else if (themeIndex === EricTheme.THEME_SNOW) { ////////////////////
        ...
        } else if (themeIndex === EricTheme.THEME_PLANT) {
        ...
        } else if (themeIndex === EricTheme.THEME_RAIN) {
        ...
        } else if (themeIndex === EricTheme.THEME_DAY) {
        ...
        } else if (themeIndex === EricTheme.THEME_NIGHT) {
        ...
        } else if (themeIndex === EricTheme.THEME_LIGHT_AND_WARM) { //////////
        ...
        } else if (themeIndex === EricTheme.THEME_DARK_AND_SPOOKY) {
        ...
        } else if (themeIndex === EricTheme.THEME_PLAIN_AND_BORING) {
        ...
        } else if (themeIndex === EricTheme.THEME_BLOOD_AND_TEARS) {
        ...
        } else if (themeIndex === EricTheme.THEME_MIGHTY_KITTENS) {
