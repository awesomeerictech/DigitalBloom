...
T.Button {
    ...
    property string primaryColor: EricTheme.colorPrimary
    property string secondaryColor: EricTheme.colorComponentBackground
    ...
    background: Rectangle {
        ...
        border.color: control.fullColor ? control.primaryColor : EricTheme.colorComponentBorder
