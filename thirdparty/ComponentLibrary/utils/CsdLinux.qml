    ...
    sourceComponent: Row {
        ...
        Rectangle { // button minimize
            ...
            Rectangle {
                ...
                color: mouseAreaMin.containsMouse ? EricTheme.colorHighContrast : EricTheme.colorIcon
            }
        ...
        Rectangle { // button maximize
            ...
            Rectangle {
                ...
                color: "transparent"
                border.width: 2
                border.color: mouseAreaMax.containsMouse ? EricTheme.colorHighContrast : EricTheme.colorIcon
            }
        ...
        Rectangle { // button close
            ...
            Rectangle {
                ...
                anchors.centerIn: parent
                rotation: 45
                color: mouseAreaClose.containsMouse ? "white" : EricTheme.colorIcon
            }
            Rectangle {
                width: 13; height: 2; radius: 2;
                anchors.centerIn: parent
