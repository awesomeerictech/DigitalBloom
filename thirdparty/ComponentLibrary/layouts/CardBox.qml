...
T.Frame {
    ...
    topPadding: header.height + EricTheme.componentMargin

    property color colorBackground: "white" // EricTheme.colorBackground
    property color colorForeground: EricTheme.colorMaterialPurple
    property color colorIcon: EricTheme.colorIcon
    ...
    background: Rectangle {
        ...
        Rectangle { // background shadow
            ...
            layer.effect: MultiEffect {
                ...
                shadowEnabled: true
                shadowColor: EricTheme.colorComponentShadow
