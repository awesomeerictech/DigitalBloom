...
T.Button {
    ...
    // colors
    property color iconColor: EricTheme.colorIcon
    property color highlightColor: EricTheme.colorPrimary
    property color borderColor: EricTheme.colorComponentBorder
    property color backgroundColor: EricTheme.colorComponent
