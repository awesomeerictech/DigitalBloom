...
T.Button {
    ...
    // colors
    property color colorContent: EricTheme.colorTabletmenuContent
    property color colorHighlight: EricTheme.colorTabletmenuHighlight
    property color colorIndicator: EricTheme.colorPrimary
    ...
    contentItem: ColumnLayout {
        ...
        Text { // contentText
            ...
            font.pixelSize: EricTheme.fontSizeContentSmall - 1
            font.bold: true
