...
T.RangeSlider {
    ...
    property color colorTicks: EricTheme.colorComponentDown
    ...
    first.handle: Rectangle {
        ...
        color: first.pressed ? EricTheme.colorSecondary : control.colorForeground
    ...
    second.handle: Rectangle {
        ...
        rotation: control.horizontal ? 0 : -90
        opacity: control.enabled ? 1 : 0.8
        color: second.pressed ? EricTheme.colorSecondary : control.colorForeground
