...
T.Button {
    ...
    // colors
    property color colorContent: EricTheme.colorComponentText
    property color colorContentHighlight: EricTheme.colorComponentContent
    property color colorBackgroundHighlight: EricTheme.colorComponentDown
