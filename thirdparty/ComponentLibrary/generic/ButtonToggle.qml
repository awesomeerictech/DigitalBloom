...
T.Button {
    ...
    // colors
    property color colorBackground: EricTheme.colorBackground
    property color colorHighlight: EricTheme.colorForeground
    ...
    background: Item {
        implicitWidth: control.text ? 80 : EricTheme.componentHeight
