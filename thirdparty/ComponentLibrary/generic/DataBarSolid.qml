...
Item {
    ...
    // colors
    property color colorForeground: EricTheme.colorPrimary
    ...
    Row {
        ...
        Text {
            ...
            font.pixelSize: EricTheme.fontSizeContentVerySmall
            font.bold: true
        ...
        Item {
            ...
            Rectangle {
                ...
                color: (control.limitMin <= control.value) ? EricTheme.colorLowContrast : EricTheme.colorHighContrast
            ...
            Rectangle {
                ...
                color: (control.limitMax < control.value) ? EricTheme.colorLowContrast : EricTheme.colorHighContrast
            ...
            Rectangle {
                ...
                Text {
                    ...
                    color: (item_data.width > indicator.width) ? "white" : EricTheme.colorSubText
