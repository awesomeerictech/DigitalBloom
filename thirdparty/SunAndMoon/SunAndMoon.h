...
class SunAndMoon: public QObject
{
    ...
    Q_PROPERTY(bool sunIsVisible READ sunIsVisible NOTIFY updated)
    ...
    Q_PROPERTY(bool moonIsVisible READ moonIsVisible NOTIFY updated)
    ...
    Q_PROPERTY(bool valid READ isValid NOTIFY updated)

    Q_PROPERTY(bool isItDay READ isItDay NOTIFY updated)
    Q_PROPERTY(bool isItNight READ isItNight NOTIFY updated)
    ...
    /// MoonRise // https://github.com/signetica/MoonRise
    ...
    /// MoonPhase // https://github.com/signetica/MoonPhase
...
public:
    ...
    bool sunIsVisible() { return (sun_percent >= 0 && sun_percent <= 100); }
    bool moonIsVisible() { return (moon_percent >= 0 && moon_percent <= 100); }

    bool isItDay() const;
    bool isItNight() const { return !isItDay(); }
};
