...
// --- UPDATED: Added 'notificationId' parameter ---
void NotificationManager::setNotification(const QString &title, const QString &message, int channel, int notificationId)
{
    ...
    m_message = message;
    m_channel = channel;
    m_notificationId = notificationId; // <--- ADDED: Store the unique ID
...
void NotificationManager::setNotificationShort(const QString &message)
{
    ...
    m_title = "";
    m_channel = 0;
    m_notificationId = 1; // <--- ADDED: Use a default ID for short notifications
...
void NotificationManager::updateNotificationAndroid()
{
    ...
    jint javaNotificationId = m_notificationId; // <--- ADDED: Get the notification ID

    QJniObject::callStaticMethod<void>(
        "org/stlltd/digitalbloom/DigitalBloomNotifier",
        "notify",
        // --- UPDATED: Added a second 'I' for the notification ID ---
        "(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)V",
        QNativeInterface::QAndroidApplication::context(),
        javaTitle.object<jstring>(),
        javaMessage.object<jstring>(),
        javaChannel,
        javaNotificationId); // <--- ADDED: Pass the notification ID
#endif
}
