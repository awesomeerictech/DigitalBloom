...
import android.os.Build; // Import Build class for version check
...
public class ActivityUtils {
    ...
    public static final String ACTION_START_SERVICE   = "org.stlltd.digitalbloom.START_SERVICE";
    public static final String ACTION_STOP_SERVICE    = "org.stlltd.digitalbloom.STOP_SERVICE";
    public static final String ACTION_RESTART_SERVICE = "org.stlltd.digitalbloom.RESTART_SERVICE";
     ...
     */
    public void registerServiceBroadcastReceiver(final Context ctx) {
        try {
            ...
            // FIX for Android 13 (API 33) SecurityException: Must specify RECEIVER_EXPORTED or RECEIVER_NOT_EXPORTED.
            if (Build.VERSION.SDK_INT >= 33) {
                // Registering as not exported, which is safe for app-internal control actions.
                ctx.getApplicationContext().registerReceiver(receiver, filter, Context.RECEIVER_NOT_EXPORTED);
            } else {
