...
if(_QX_ENABLE_BOOST)
   ...
   add_compile_definitions(_QX_ENABLE_BOOST)
...
if(_QX_ENABLE_MONGODB)
   ...
   add_compile_definitions(_QX_ENABLE_MONGODB)
...
add_compile_definitions(_QX_NO_PRECOMPILED_HEADER)
...
option(_QX_STATIC_BUILD "Enable _QX_STATIC_BUILD option to build QxOrm as a static library" ON)

if(_QX_STATIC_BUILD)

    if(CMAKE_C_COMPILER_ID STREQUAL "MSVC")
        add_compile_definitions(_QX_STATIC_BUILD=1)
    else()
        add_compile_definitions(_QX_STATIC_BUILD=1)
    endif()
...
if(_QX_STATIC_BUILD)
    ...
    if(CMAKE_C_COMPILER_ID STREQUAL "MSVC")
        add_compile_definitions(_QX_STATIC_BUILD)
    else()
        add_compile_definitions(_QX_STATIC_BUILD)
    endif()
...
if (CMAKE_C_COMPILER_ID STREQUAL "MSVC")
    add_compile_options(/D_QX_STATIC_BUILD=1)
else()
    add_compile_options(-D_QX_STATIC_BUILD=1)
endif()
...
if(_QX_ENABLE_BOOST_SERIALIZATION)
   ...
   add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION)
   ...
   if(_QX_ENABLE_BOOST_SERIALIZATION_BINARY)
      add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION_BINARY)
   endif()

   if(_QX_ENABLE_BOOST_SERIALIZATION_XML)
      add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION_XML)
   endif()

   if(_QX_ENABLE_BOOST_SERIALIZATION_POLYMORPHIC)
      add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION_POLYMORPHIC)
   endif()

   if(_QX_ENABLE_BOOST_SERIALIZATION_TEXT)
      add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION_TEXT)
   endif()

   if(_QX_ENABLE_BOOST_SERIALIZATION_PORTABLE_BINARY)
      add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION_PORTABLE_BINARY)
   endif()

   if(_QX_ENABLE_BOOST_SERIALIZATION_WIDE_BINARY)
      add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION_WIDE_BINARY)
   endif()

   if(_QX_ENABLE_BOOST_SERIALIZATION_WIDE_TEXT)
      add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION_WIDE_TEXT)
   endif()

   if(_QX_ENABLE_BOOST_SERIALIZATION_WIDE_XML)
      add_compile_definitions(_QX_ENABLE_BOOST_SERIALIZATION_WIDE_XML)
   endif()
...
if(_QX_ENABLE_QT_GUI)
   add_compile_definitions(_QX_ENABLE_QT_GUI)
...
if(_QX_ENABLE_QT_NETWORK)
   add_compile_definitions(_QX_ENABLE_QT_NETWORK)
...
if(_QX_NO_JSON)
   add_compile_definitions(_QX_NO_JSON)
endif()
...
if(_QX_UNITY_BUILD)
   add_compile_definitions(_QX_UNITY_BUILD)
   if(WIN32 AND MSVC)
